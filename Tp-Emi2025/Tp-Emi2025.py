...
class GestorTurnos:
    ...
    def modificar_turno(self, id_turno, nueva_fecha=None, nueva_hora=None, nuevo_servicio=None):
        i = 0
        while i < len(self.turnos):
            turno = self.turnos[i]
            if turno.id_turno == id_turno:
                ...
                while j < len(self.turnos):
                    ...
                    if (otro_turno.id_turno != id_turno and 
        ...
        return "Error: No aparece ni con lupa"
